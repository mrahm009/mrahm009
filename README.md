[README.md](https://github.com/user-attachments/files/27612530/README.md)
# Md Mahfuzur Rahman, Ph.D. Candidate

**Mechanical & Aerospace Engineering | Old Dominion University**  
📍 Norfolk, VA | 📧 mrahm009@odu.edu | [LinkedIn](#) | [Google Scholar](#) | [ORCiD](#)
...
| Area | Details |
|------|---------|
| **Wearable Sensing** | Microfluidic tactile sensors & accelerometer-based pulse acquisition |
| **Signal Processing** | FFT, EMD, CDM, HHT, HVD for non-stationary physiological signals |
| **Clinical Validation** | IRB-approved studies with cardiac rehab patients at Sentara Heart Hospital |
...
**6 peer-reviewed journal articles** (4 as first author) | **2 conference proceedings**

### Selected Publications
- **Rahman, M.M.** et al. (2025). *An Analytical Model of Motion Artifacts in a Measured Arterial Pulse Signal — Part I: Accelerometers and PPG Sensors.* **Sensors**, 25(18), 5710. [IF ≈ 3.5; Q2] [DOI](https://doi.org/10.3390/s25185710)
...
```
Microfabrication     │ Photolithography · PDMS casting · Plasma bonding · Thin-film deposition
Circuit Design       │ KiCad PCB design · Transimpedance amplifiers · Analog front-end circuits
Signal Processing    │ MATLAB · Python · FFT · EMD · HHT · HVD · LabVIEW
Clinical Research    │ IRB protocols · REDCap · CITI certified · Human subject studies
CAD & Design         │ AutoCAD · Autodesk Inventor · Multisim · SolidWorks (foundational)
...
|------|-------------|--------|
| Graduate Teaching Assistant (Instructor) | Old Dominion University, USA | 2022 – Present |
| Graduate Teaching Assistant (Grader) | Old Dominion University, USA | 2019 – Present |
...
- 🔬 **NSF Grant #1936005** — Noninvasive Cardiovascular Sensing Systems (2019–Present)

---

## 📄 CV & Contact

- 📥 [Download Academic CV](./Curriculum_Vitae.pdf)
